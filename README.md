...
In this projet, we tried to understand what were the tendencies regarding real estate in France for the year 2020. 
We also compare it with the 2019 results.

# Preprocessing

The first part transforms the raw data into a valuable dataset easy to plot. We notably get rid of nan values, inconsistencies or redundancy using simple Python function.

# Analysis of the 2020 data

We mainly use pyplot, pandas, seaborn, squarify, circlify to extract informations out of our dataset.
...
One of our main achivements was to create interactive maps of France or the city of Paris to allow us to make our data understandable for everyone.
